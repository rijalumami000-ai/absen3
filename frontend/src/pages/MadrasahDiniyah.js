...
import { Plus, Edit2, Trash2, QrCode, Search, Link, UserPlus, Users, FileDown, CreditCard, Link2, User } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
                    ...
                    <td className="px-6 py-4 text-sm text-foreground">
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          ...
                          title={siswa.santri_id ? 'Siswa link dari santri' : 'Siswa manual Madrasah'}
                        >
                          {siswa.santri_id ? (
      ...
      <Dialog open={nfcDialogOpen} onOpenChange={setNfcDialogOpen}>
        <DialogContent className="max-w-md">
          <DialogHeader>
            <DialogTitle>
              Daftarkan NFC - {selectedNfcSiswa?.nama}
            </DialogTitle>
          </DialogHeader>
          <div className="space-y-4">
            <div>
